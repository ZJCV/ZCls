...
arch_settings = {
    'resnet18': (AttentionResNetBasicBlock, (2, 2, 2, 2), 1, 64),
    'resnet34': (AttentionResNetBasicBlock, (3, 4, 6, 3), 1, 64),
    'resnet50': (AttentionResNetBottleneck, (3, 4, 6, 3), 1, 64),
    'resnet101': (AttentionResNetBottleneck, (3, 4, 23, 3), 1, 64),
    'resnet152': (AttentionResNetBottleneck, (3, 8, 36, 3), 1, 64),
    'resnext50_32x4d': (AttentionResNetBottleneck, (3, 4, 6, 3), 32, 4),
    'resnext101_32x8d': (AttentionResNetBottleneck, (3, 4, 23, 3), 32, 8)
}
