...
def test_shufflenet_v2():
    cfg.merge_from_file('configs/benchmarks/shufflenet/shufflenet_v2_x1_0_zcls.yaml')
    print(cfg)
    ...
    cfg.merge_from_file('configs/benchmarks/shufflenet/shufflenet_v2_x1_0_torchvision.yaml')
