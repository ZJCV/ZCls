...
def test_mnasnet():
    cfg.merge_from_file('configs/cifar/mnasnet_a1_1_3_cifar100_224_e100.yaml')
    ...
    cfg.merge_from_file('configs/cifar/mnasnet_b1_1_3_torchvision_cifar100_224_e100_sgd.yaml')
    for wm in [0.5, 0.75, 1.0, 1.3]:
        cfg.MODEL.COMPRESSION.WIDTH_MULTIPLIER = wm
